...
const config = {
  anniversaydate: 'March 27, 2025',
  name: 'Shivani Abhishek Geharwar'
};
...
let countDown = new Date(`${config.anniversaydate} 00:00:00`).getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'ANNIVERSARY!', 'MY WORLD', config.name],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
